  ...
  protected static function massageFieldData(array $source) {
    ...
    foreach ($source as $delta => $instance) {
      ...
      $style_map = [
        ...
        'hero-style-1-left' => 'utexas_hero_2_left',
        'hero-style-1-center' => 'utexas_hero_2',
        'hero-style-1-right' => 'utexas_hero_2_right',
        ...
        'hero-style-4-left' => 'utexas_hero_3_left',
        'hero-style-4-center' => 'utexas_hero_3',
        'hero-style-4-right' => 'utexas_hero_3_right',
