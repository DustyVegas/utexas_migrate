...
/**
 * Provides a 'utexas_media_document_destination' destination plugin.
 *
 * @MigrateDestination(
 *   id = "utexas_media_document_destination"
 * )
 */
class DocumentDestination extends MediaDestination implements MigrateDestinationInterface {
  ...
  public function import(Row $row, array $old_destination_id_values = []) {
    ...
    if ($this->importedFile) {
      ...
      $this->mediaElements['bundle'] = 'utexas_document';
      // Add document-specific elements to the media object.
      $this->mediaElements['field_media_file'] = [
